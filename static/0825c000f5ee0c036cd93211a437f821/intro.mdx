...
disponible via ce [lien](https://jakarta.ee/specifications/platform/10/jakarta-platform-spec-10.0),
...
**JAX-RX Specification** : https://jakarta.ee/specifications/restful-ws/3.1/jakarta-restful-ws-spec-3.1
<br/>
...
la meilleure documentation est le **Jersey 3.1.5 User Guide** : https://eclipse-ee4j.github.io/jersey.github.io/documentation/latest31x/index.html
<br/>
